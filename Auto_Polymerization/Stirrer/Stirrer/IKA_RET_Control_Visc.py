...
sys.path.append(
    os.path.abspath(os.path.dirname(__file__))) # get import path : IKA_RET_Control_Visc.py
sys.path.append(
    os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))  # get import path : logger.py
sys.path.append(
    os.path.abspath(os.path.join(os.path.dirname(__file__), "serial_labware")))

# HERE = os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))
# sys.path.append(os.path.join(HERE, 'serial_labware'))

# additional module imports
from serial_labware.serial_labware_py import SerialDevice,command
...
if __name__ == '__main__':
    ...
    hp = IKARETControlVisc(port="COM7", connect_on_instantiation=True)
    
    hp.temperature_sp = 80  # setting temperature to 80 °C
    #hp.start_heater()  # starting the heater

    # for _ in range(100):
    #     print("플레이트 내부 센서 온도 : {}".format(hp.temperature_pv))
    #     print("실제 측정된 온도 :  {}".format(hp.temperature_hot_plate_pv))
    #     print("세팅한 온도 : {}".format(hp.temperature_hot_plate_sp))
    #     time.sleep(10)
    ...
    # #
    # hp = IKARETControlVisc(port='COM5', device_name='IKARET', connect_on_instantiation=True)
    #hp.stop_stirrer()  # stopping heater
    # # temp = hp.temperature_hot_plate_pv
    # # print(float(temp[0]))
    # hp.temperature_sp = 100
    # hp.start_heater()
    # time.sleep(10)
    # print(hp.temperature_hot_plate_pv)
    # on_time = []
    # on_temp = []
    # on_sensor = []
    # i = 0
    # while True:
    #     on_time.append(datetime.datetime.now())
    #     #temp_plate = hp.temperature_hot_plate_pv
    #     #print(float(temp_plate[0]))
    #     temp = hp.temperature_pv
    #     print(float(temp[0]))
    #     #on_temp.append(float(temp_plate[0]))
    #     on_sensor.append(float(temp[0]))
    #     time.sleep(5)
    #     print(temp[0])
    #     if float(temp[0]) > 97:
    #         break
    ...
    # i = 0
    # while True:
    #     off_time.append(datetime.datetime.now())
    #     temp = hp.temperature_hot_plate_pv
    #     off_temp.append(float(temp[0]))
    #     time.sleep(1)
    #     if float(temp[0]) < 25:
    #         break
    #     i += 1

    # with open('heating_test_100.csv', 'w', newline='') as f:
    #     writer = csv.writer(f)
    #     writer.writerow(on_time)
    #     # writer.writerow(on_temp)
    #     # writer.writerow(off_time)
    #     # writer.writerow(off_temp)
    #     writer.writerow(on_sensor)



    hp.start_stirrer(400)
    ...
    # hp.stop_stirrer()
    # print("stir error")
    # print(hp.temperature_pv)
    # print(hp.stir_rate_pv)
    # hp.stop_heater()
    # hp.stop_stirrer()
    # plate = ()
    # sensor = ()
    # plate = hp.temperature_hot_plate_pv
    # print(float(plate[0]))
    # sensor = hp.temperature_pv
    # print(float(sensor[0]))
