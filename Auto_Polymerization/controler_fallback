...
Version of the controller which worked and where I can come back to if I need get to the last stable version
...
#loading of json file for layout of the medusa setup (typically stored  in config folder)
def find_layout_json(config_folder='Auto_Polymerization/src/users/config/'):
    """
